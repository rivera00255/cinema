      ...
      <svg
        ...
        <g id="Spinner_x5F_0_x25_">
          <g>
            ...
            <ellipse
              transform="matrix(0.9968 -0.0794 0.0794 0.9968 -4.0326 2.3121)"
              cx="27.045"
              cy="51.843"
              rx="1.959"
              ry="1.959"
            />
            <ellipse
              transform="matrix(0.9968 -0.0794 0.0794 0.9968 -4.628 2.4912)"
              cx="28.998"
              cy="59.416"
              rx="1.959"
              ry="1.959"
            />
            <ellipse
              transform="matrix(0.9968 -0.0794 0.0794 0.9968 -5.1348 2.8556)"
              cx="33.325"
              cy="65.967"
              rx="1.959"
              ry="1.959"
            />
            <ellipse
              transform="matrix(0.9968 -0.0794 0.0794 0.9968 -5.4877 3.3713)"
              cx="39.63"
              cy="70.661"
              rx="1.959"
              ry="1.959"
            />
            <ellipse
              transform="matrix(0.9968 -0.0794 0.0794 0.9968 -5.6506 3.9762)"
              cx="47.152"
              cy="73.012"
              rx="1.959"
              ry="1.959"
            ...
            <g>
              ...
              <g>
                <ellipse
                  transform="matrix(1 -0.0026 0.0026 1 -0.1096 0.1874)"
                  cx="72.131"
                  cy="42.296"
                  rx="1.959"
                  ry="1.959"
                />
                <ellipse
                  transform="matrix(1 -0.0026 0.0026 1 -0.0918 0.1775)"
                  cx="68.321"
                  cy="35.432"
                  rx="1.959"
                  ry="1.959"
                />
                <ellipse
                  transform="matrix(1 -0.0026 0.0026 1 -0.0784 0.1621)"
                  cx="62.395"
                  cy="30.267"
                  rx="1.959"
                  ry="1.959"
                />
                <ellipse
                  transform="matrix(1 -0.0026 0.0026 1 -0.0708 0.1431)"
                  cx="55.076"
                  cy="27.346"
                  rx="1.959"
                  ry="1.959"
